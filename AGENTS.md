...
- **Shell** (always works): `codegraph sync && codegraph --path /some-path explore "<symbol names or question>"` prints the output and MUST collect all the output for references.
<!-- CODEGRAPH_END -->