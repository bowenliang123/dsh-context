...
- **Shell** (always works): `codegraph sync && codegraph explore --path /some-path "<symbol names or question>"` prints the output and MUST collect all the output for references.
<!-- CODEGRAPH_END -->