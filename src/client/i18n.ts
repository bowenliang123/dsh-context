...
export const DICT_ZH: Record<string, string> = {
  ...
  'settings.title': '上下文', 'settings.desc': '上下文面板的展示偏好',
  ...
  'files.glyph.shell': 'Shell', 'files.glyph.web': '网页', 'files.glyph.style': '样式',
  'files.glyph.database': '数据库', 'files.glyph.code': '代码', 'files.glyph.data': '数据清单',
...
export const DICT_EN: Record<string, string> = {
  ...
  'settings.title': 'Context', 'settings.desc': 'Display preferences for the Context panel',
  ...
  'files.glyph.shell': 'Shell', 'files.glyph.web': 'Web page', 'files.glyph.style': 'Styles',
  'files.glyph.database': 'Database', 'files.glyph.code': 'Code', 'files.glyph.data': 'Data / manifest',
