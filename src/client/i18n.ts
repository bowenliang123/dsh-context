...
export const DICT_ZH: Record<string, string> = {
  ...
  'stats.images': '图片',
  'stats.cost': '预估费用',
  'stats.costTip': '按 DeepSeek 官方刊例价估算整个会话的累计费用：输入区分缓存命中/未命中，输出含思考；按请求时间区分高峰（北京时间工作日 9:00–12:00、14:00–18:00）与空闲时段（半价，周末全天均为空闲时段）。适用于 deepseek-v4.1-flash / deepseek-flash / deepseek-v4-pro（不限 provider；两个系列各按自己的单价计费），价格写死在代码中，仅供参考。',
