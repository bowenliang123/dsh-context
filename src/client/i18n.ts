...
export const DICT_ZH: Record<string, string> = {
  ...
  'settings.placement': '展示位置',
  'placement.tab': '会话标签页', 'placement.sidebar': '侧边栏', 'placement.all': '标签页和侧边栏',
...
export const DICT_EN: Record<string, string> = {
  ...
  'settings.placement': 'Show in',
  'placement.tab': 'Conversation tab', 'placement.sidebar': 'Sidebar', 'placement.all': 'Both',
