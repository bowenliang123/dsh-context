...
export const DICT_ZH: Record<string, string> = {
  ...
  'stats.images': '图片',
  'stats.cost': '预估费用',
  'stats.costTip': '按 DeepSeek 官方刊例价估算本会话及其全部子代理的累计费用：输入区分缓存命中/未命中，输出含思考；按请求时间区分高峰（北京时间工作日 9:00–12:00、14:00–18:00）与空闲时段（半价，周末全天均为空闲时段）。适用于 deepseek-v4.1-flash / deepseek-flash / deepseek-v4-pro（不限 provider；V4.1 Pro 上线前，V4 Pro 请求将被路由并按 V4.1 Flash 单价计费），价格写死在代码中，仅供参考。',
  'stats.costOwn': '主', 'stats.costSub': '子',
  'stats.costSubCount': '含 {n} 个子代理会话',
