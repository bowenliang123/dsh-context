...
export const DICT_ZH: Record<string, string> = {
  ...
  'files.search': '按路径过滤…',
  'files.sort.count': '按次数', 'files.sort.latest': '按最新',
  'files.sortTip': '文件排序：按操作总次数或最近操作时间',
  'files.files': '{n} 个文件',
...
export const DICT_EN: Record<string, string> = {
  ...
  'files.sort.count': 'Most active', 'files.sort.latest': 'Latest',
  'files.sortTip': 'Sort files by total operations or by most recent activity',
  'files.files': '{n} files',
