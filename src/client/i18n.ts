...
export const DICT_ZH: Record<string, string> = {
  ...
  'stats.prunes': '剪枝',
  'plugin.title': '插件信息',
  'plugin.hint': '感谢使用 · 欢迎 Star 与反馈 ⭐',
  'plugin.name': '插件',
  'plugin.version': '版本',
  'plugin.updateBadge': 'Update!',
  'plugin.updateTip': '新版本 v{v} 可用 · 执行 dsh plugin --profile web add dsh-context 更新（点击前往 npm）',
  'tools.top': '工具定义 Top：',
  'tools.more': '等 {n} 个',
  'trend.title': '历史趋势',
...
export const DICT_EN: Record<string, string> = {
  ...
  'overview.splitEst': '· category split is estimated',
